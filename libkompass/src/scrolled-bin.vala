namespace Kompass {
public enum ScrolledBinBehaviour {
  ALTERNATE,
  SLIDE
}

public class ScrolledBin : Gtk.Widget, Gtk.Orientable, Gtk.Buildable {
   ...
   * [property@Kompass.ScrolledBin:behaviour] is set to alternate.
   */
   ...
   */
  public ScrolledBinBehaviour behaviour { get; set; default = ScrolledBinBehaviour.ALTERNATE; }
  ...
  private bool update_position(Gtk.Widget widget, Gdk.FrameClock clock) {
    ...
    if (this.behaviour == ScrolledBinBehaviour.ALTERNATE) {
