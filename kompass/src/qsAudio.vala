...
public class Kompass.QsAudio : Gtk.Box {
    ...
    construct {
        ...
        this.wp.audio.default_speaker.bind_property("volume", speaker_adjust, "value", GLib.BindingFlags.BIDIRECTIONAL | GLib.BindingFlags.SYNC_CREATE);
        this.wp.audio.default_microphone.bind_property("volume", mic_adjust, "value", GLib.BindingFlags.BIDIRECTIONAL | GLib.BindingFlags.SYNC_CREATE);
